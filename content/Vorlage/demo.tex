...
\textbf{fett},
\textit{kursiv\footnote{kursiv und schr�ggestellt sind unterschiedliche Schriften und daher nicht das gleiche !} (italic)},
...
%
Mit dem Paket \package{ragged2e} und der Umgebung \env{FlushLeft} bzw. dem Befehl \command{Raggedright} wird Flattersatz (Gegenteil von Blocksatz) gegen�ber dem \LaTeX{} Standard noch verbessert.
...
%
Mit dem Paket \package{ragged2e} und der Umgebung \env{FlushRight} bzw. dem Befehl \command{RaggedLeft} wird Flattersatz (Gegenteil von Blocksatz) gegen�ber dem \LaTeX{} Standard noch verbessert.
...
Ein Text in einer \env{quote} Umgebung\footnote{F�r Zitate eignet sich allerdings eher die Umgebung \env{blockquote} vom Paket \package{csquotes}}. Der gesammte Text innerhalb der Umgebung wird von beiden Seiten einger�ckt.
...
Die eleganteste L�sung bietet das Paket \package{enumitem} mit der Option `noitemsep'
...
%
\subsection{Normale figure Umgebung mit subcaption}
...
\begin{figure}[H]
   ...
   \begin{subfigure}[b]{0.3\textwidth}
       \includegraphics[width=\textwidth]{images/latex}
       \caption{Erstes Bild}
   \end{subfigure}
   \hspace{0.1\textwidth}
   \begin{subfigure}[b]{0.3\textwidth}
...
%
\subsection{wrapfloat mit subcaption}
...
Bei allen hier vorgestellten Tabellen sind Befehle in die Tabellen eingef�gt die den Stil ver�ndern.
