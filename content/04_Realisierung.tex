...
4) Observation: Agent parst Traceback, findet NullPointer-ähnlichen Fehler in Helper-Funktion, die neu extrahiert wurde. Memory-Manager liefert ähnlichen früheren Fall (Match on signature), Agent übernimmt Erkenntnisse aus historischem Patch.

5) Reflection 
\begin{sloppypar}
\begin{itemize}
  \item Agent generiert Patch-Vorschlag (kleinen Scope-Fix im Helper), erstellt Diff und führt Tests erneut in isolierter Sandbox aus.
...
\begin{itemize}
  ...
  \item \textbf{Review-Akzeptanz:} Manuelles Review ergab \pct{81} „would merge“-Rate
\end{itemize}
\end{sloppypar}
...
\begin{itemize}
  ...
  \item Safety-Layer: 28 Tests, \pct{92} Abdeckung
\end{itemize}
\end{sloppypar}
