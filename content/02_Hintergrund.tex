...
Grenzen sind längere Latenzen durch zusätzliche LLM-Aufrufe und potentielle Halluzinationen in Reasoning-Traces.
...
\textbf{MetaGPT} \cite{hong2023metagpt} simuliert ein Software-Team mit Rollen wie Product Manager, Architekt, Entwickler und QS. Agents produzieren strukturierte Artefakte (PRDs, Design-Dokumente, Code, Tests) und folgen einem definierten Workflow.
...
\begin{enumerate}
  ...
  \item Praxisnahe Implementierung mit Tool-Interface-Richtlinien
